...
sui client new-address ed25519 MY_ALIAS	C                              reate a new address with ED25519 scheme and alias
...
main mve.toml change karl lena acc to docs
move contract apne hisab se likh lo
...
(base) ajiteshjamulkar@Ajiteshs-MacBook-Pro my_contract % sui client call --package <package_id in deployed> \
  --module example \
